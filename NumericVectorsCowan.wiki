...
This design subsumes [[http://srfi.schemers.org/srfi-4/srfi-4.html|SRFI 4]], and the sample implementation provides an implementation of it.  There are many procedures, but many of them can be easily inlined by even a very dumb compiler, providing high efficiency.   The procedures provided in the present proposal are the numeric-vector analogues of the [[http://srfi.schemers.org/srfi-133/srfi-133.html|SRFI 133]] procedures.
