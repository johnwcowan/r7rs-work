...
[[http://dekudekuplex.wordpress.com/|"Monadically Speaking:  Adventures in PLT Wonderland"]] ("PLT" referring
to "Programming Language Theory," not to be confused with the PLT
Research Group) (also duplicated
as a [[http://dekudekuplex.sakura.ne.jp/blog/en/|WordPress.org private blog]]).
...
Having read through many of the [[http://www.r6rs.org/ratification/results.html|opinions]] both for and against the
...
this spirit:
  ...
  * the size of the standard library
  ...
  two major disadvantages:
    ...
    2) So many standard libraries render R6RS Scheme impractical for most current embedded systems, which are limited in available memory and processing power.  Since Scheme is often used as a scripting language, a small collection of standard libraries would encourage the use of Scheme for developing embedded systems; the set of standard libraries in R6RS Scheme, on the other hand, discourages such development.  Instead, Chris Hanson proposed an [[http://www.r6rs.org/ratification/results.html#X78|alternative]] to the current module system, as follows:
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;For example, consider the following examples of code defining the square function (quoted from <a href="http://mitpress.mit.edu/catalog/item/default.asp?ttype=2&tid=3662">&#91;1&#93;</a>):  
    ...
    {{{function SquareOfWholeNumber(num: integer): integer;}}}[[BR]]
      {{{begin}}}[[BR]]
        {{{SquareOfWholeNumber := num * num}}}[[BR]]
      {{{end;}}}[[BR]]
    {{{function SquareOfDecimalNumber(num: real): real;}}}[[BR]]
      {{{begin}}}[[BR]]
...
detrimental to reading code.  One reason that [[http://practical-scheme.net/gauche/index.html|Gauche Scheme]], an implementation of
...
[[http://karetta.jp/book-cover/gauche-hacks|"Karetta | Gauche Programming (Browsing Version)"]] (in Japanese), in which one
...
examples (see [[http://homepage2.nifty.com/PAF00305/lib/unicode.html|"Unicode Test Page ♦ ユニコード テスト ページ [Unicode Test Page]]"]).
