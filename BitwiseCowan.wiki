...
Hence this SRFI, which is based mainly on [[http://srfi.schemers.org/srfi-33/srfi-33.html|SRFI 33]], with some changes and additions from [[http://srfi.schemers.org/srfi-33/mail-archive/msg00023.html|Olin's late revisions to SRFI 33]] (which were never consummated).
SRFI 33 was never finalized, but is a reasonably comprehensive proposal.
A few procedures have been added from [[http://srfi.schemers.org/srfi-60/srfi-60.html|SRFI 60]] and
the general vector [[http://srfi.schemers.org/srfi-133/srfi-133.html|SRFI 133]].  
...
[[http://www.r6rs.org/final/html/r6rs-lib/r6rs-lib-Z-H-12.html#node_sec_11.4|R6RS]]
