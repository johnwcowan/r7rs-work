...
* **Default:** keep
* **Preferences:** shrink/core, shrink, undecided, keep
...
* **Options:** yes, no, undecided
* **Default:** no
* **Preferences:** r5rs+strictly, r5rs, yes, undecided
...
* **Default:** eager
* **Preferences:** make-promise, promise, eager
...
* **Default:** unspecified
* **Preferences:** unspecified, circular
...
* **Default:** nothing
* **Preferences:** srfi, r5rs, srfi-plus, undecided, nothing
...
* **Default:** unspecified
* **Preferences:** unquote-splicing, invalid
...
* **Options:** yes, no, undecided
* **Default:** no
* **Preferences:** wg2, no, undecided, yes
...
> What is important is that references are non ambiguous, there are no risks if unused identifiers collide.
> If an identifier with multiple meanings is not used, there is no ambiguity, nor real conflict.
...
* **Default:** start
* **Preferences:** start-split, start, undecided, later
...
* **Default:** none
* **Preferences:** 16, 24, none, undecided
