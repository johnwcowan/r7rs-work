...
phasing.
  ...
  * '''Default:''' r6rs
  * '''Preferences:''' shinn, r6rs--, ganz, hsu, r6rs 
...
is easily provided as a separate module, and will be a separate item.
  ...
  * '''Default:''' no
  * '''Preferences:''' srfi-89,wg2,dsssl,no
...
to a random variables in WG1 Scheme?
  ...
  * '''Default:''' no
  * '''Preferences:''' no,wg2,cowan|srfi-27
...
and `equal?+r6rs` or `equal?+srfi-1` are options for both.
  ...
  * '''Default:''' no
  * '''Preferences:''' equal?+srfi,equal?+r6rs,srfi-1,r6rs,module,wg2,no
...
exception handling, not the conditions hierarchy.
  ...
  * '''Default:''' none
  * '''Preferences:''' cowan,wg2,r6rs,none
...
`error` procedure.
  ...
  * '''Default:''' no
  * '''Preferences:''' wrfi-23,both,wg2,no
...
Note that currently PortsCowan provides SRFI-6 string ports.
  ...
  * '''Default:''' no
  * '''Preferences:''' no,srfi-6,r6rs,wg2
...
`write` to handle cyclic notation.
  ...
  * '''Default:''' no
  * '''Preferences:''' native, srfi-38, wg2, no 
...
Do we allow either or both of these extensions?
  ...
  * '''Default:''' no
  * '''Preferences:''' both,tail,dotted-tail,wg2,no
...
Do we want either or both of these?
  ...
  * '''Default:''' no
  * '''Preferences:''' wg2, both, r6rs, r5rs, no 
...
to come later from specific proposals.
  ...
  * '''Default:''' yes
  * '''Preferences:''' unspecified, no, yes 
...
The exact list of added names is to be decided later.
  ...
  * '''Default:''' no
  * '''Preferences:''' numeric,both,mnemonic,wg2,no
...
either or both of these?
  ...
  * '''Default:''' no
  * '''Preferences:''' both, sexp, block, wg2, no 
...
constituents.
  ...
  * '''Default:''' no
  * '''Preferences:''' both,numeric,quoted,wg2,no
...
extensions?
  ...
  * '''Default:''' no
  * '''Preferences:''' both,numeric,mnemonic,wg2,no
...
Note UnicodeCowan currently provides mappings at both levels.
  ...
  * '''Default:''' no
  * '''Preferences:''' no,module,wg2,strings,chars,both
...
procedures.
  ...
  * '''Default:''' no
  * '''Preferences:''' generic,agnostic,seperate,specific,wg2,no
...
as those provided by SRFI-39 parameters.
  ...
  * '''Default:''' none
  * '''Preferences:''' cowan, snellpym, srfi-39, wg2, none
...
or the R6RS record system?
  ...
  * '''Default:''' no
  * '''Preferences:''' snellpym,rush,hsu,srfi-99,srfi-9,wg2,no 
