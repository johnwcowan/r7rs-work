...
**This proposal is obsolete.  Most of it other than settings lists was adopted by WG1.  Settings lists have now become a WG2 proposal at [SettingsListsCowan](SettingsListsCowan.md).**
...
* Rejected by WG1, see #29 and [WG1Ballot2Results](WG1Ballot2Results.md)
* string ports (SRFI-6-compatible)
* Accepted by WG1, see #30 and [WG1Ballot1Results](WG1Ballot1Results.md)
* binary ports
* Accepted by WG1, see #28 and [WG1Ballot2Results](WG1Ballot2Results.md)
* blob ports (the binary version of string ports)
* Accepted by WG1, see #149 and [WG1Ballot3Results](WG1Ballot3Results.md)
* `current-error-port`
* Accepted by WG1, see #59 and [WG1Ballot1Results](WG1Ballot1Results.md)
* `flush-output-port`
* Accepted by WG1, see #134 and [WG1Ballot3Results](WG1Ballot3Results.md)
* `read-line`
* Accepted by WG1, see #133 and [WG1Ballot3Results](WG1Ballot3Results.md)
* `delete-file`, and `file-exists?` from R6RS
* Accepted by WG1, see #60 and [WG1Ballot1Results](WG1Ballot1Results.md)
...
> Specifies what character encoding to use on a binary port.  The (case insensitive) value `US-ASCII` MUST be supported.  The values `ISO-8859-1` and `UTF-8` SHOULD be supported if the implementation contains the appropriate repertoire of characters.  Other values MAY be supported, which SHOULD appear in the [IANA list of encodings](http://www.iana.org/assignments/character-sets).  The default value is implementation-dependent.
