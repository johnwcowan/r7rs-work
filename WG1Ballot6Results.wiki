...
`case`.
  ...
  * '''Voters:''' 
    ...
    * [[:WG1BallotMedernach|Medernach]]: same-bits, r6rs/all, r6rs, r5rs
...
its SRFI-38 implementation.
  ...
  * '''Voters:''' 
    ...
    * [[:WG1BallotRead|Read]]: bang-long, no
...
The `matrix` proposal requires all 4^3^=64 conversions.
  ...
  * '''Default:''' no
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: list+vector
    * [[:WG1BallotGanz|Ganz]]: vector, matrix
    * [[:WG1BallotGleckler|Gleckler]]: no, list+vector, vector
    * [[:WG1BallotHsu|Hsu]]: vector, list+vector, list, no
    * [[:WG1BallotLucier|Lucier]]: list, list+vector, no
    * [[:WG1BallotMedernach|Medernach]]: no, vector, list+vector, list, undecided, latin-1, matrix
    * [[:WG1BallotRead|Read]]: undecided
    * [[:WG1BallotShinn|Shinn]]: no, list, vector, list+vector, latin-1
    * [[:WG1BallotSnellPym|SnellPym]]: vector, list, (list+vector matrix latin-1)
...
or `add` to have all three.
  ...
  * '''Default:''' no
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: replace
    * [[:WG1BallotGanz|Ganz]]: replace
    * [[:WG1BallotGleckler|Gleckler]]: replace
    * [[:WG1BallotHsu|Hsu]]: undecided, add
    * [[:WG1BallotLucier|Lucier]]: add, replace, no
    * [[:WG1BallotMedernach|Medernach]]: replace
    * [[:WG1BallotRead|Read]]: replace
    * [[:WG1BallotShinn|Shinn]]: replace, add
    * [[:WG1BallotSnellPym|SnellPym]]: replace, add, no
...
than the input vector, or `default` for the current status quo.
  ...
  * '''Default:''' default
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: default
    * [[:WG1BallotGanz|Ganz]]: error
    * [[:WG1BallotGleckler|Gleckler]]: remove, error, required
    * [[:WG1BallotHsu|Hsu]]: undecided
    * [[:WG1BallotLucier|Lucier]]: undecided
    * [[:WG1BallotMedernach|Medernach]]: remove, error, default, undecided, required
    * [[:WG1BallotRead|Read]]: remove
    * [[:WG1BallotShinn|Shinn]]: remove, default, error
    * [[:WG1BallotSnellPym|SnellPym]]: error, remove, required, default
...
whether the exception is continuable.
  ...
  * '''Voters:''' 
    ...
    * [[:WG1BallotGleckler|Gleckler]]: no
    * [[:WG1BallotHsu|Hsu]]: no, undecided
    * [[:WG1BallotLucier|Lucier]]: undecided
    * [[:WG1BallotMedernach|Medernach]]: undecided, no
    * [[:WG1BallotShinn|Shinn]]: no
    * [[:WG1BallotSnellPym|SnellPym]]: yes, no
...
`neither` to leave both unchanged.
  ...
  * '''Default:''' neither
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: both, utf8->string
    * [[:WG1BallotGanz|Ganz]]: both
    * [[:WG1BallotGleckler|Gleckler]]: both, utf8->string, no
    * [[:WG1BallotLucier|Lucier]]: both
    * [[:WG1BallotMedernach|Medernach]]: both
    * [[:WG1BallotRead|Read]]: both
    * [[:WG1BallotShinn|Shinn]]: both
    * [[:WG1BallotSnellPym|SnellPym]]: both, utf8->string, (string->utf8 neither)
...
raise an exception or fail to exit (from #374).
  ...
  * '''Default:''' unspecified
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: boolean
    * [[:WG1BallotGanz|Ganz]]: boolean
    * [[:WG1BallotGleckler|Gleckler]]: boolean, unspecified
    * [[:WG1BallotHsu|Hsu]]: boolean
    * [[:WG1BallotLucier|Lucier]]: boolean, unspecified
    * [[:WG1BallotMedernach|Medernach]]: boolean, unspecified, undecided, extended-true
    * [[:WG1BallotShinn|Shinn]]: extended-true, boolean
    * [[:WG1BallotSnellPym|SnellPym]]: boolean, extended-true, unspecified
...
`emergency-exit` as a secondary option after it.
  ...
  * '''Default:''' no
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: exit-immediately, emergency-exit
    * [[:WG1BallotGanz|Ganz]]: abort, emergency-exit
    * [[:WG1BallotGleckler|Gleckler]]: exit-immediately, emergency-exit
    * [[:WG1BallotHsu|Hsu]]: no
    * [[:WG1BallotLucier|Lucier]]: no
    * [[:WG1BallotMedernach|Medernach]]: exit-immediately, emergency-exit, undecided, no
    * [[:WG1BallotRead|Read]]: exit!, emergency-exit
    * [[:WG1BallotShinn|Shinn]]: no
    * [[:WG1BallotSnellPym|SnellPym]]: no, emergency-exit
...
be supported.  Vote `keep` to leave them as-is.
  ...
  * '''Default:''' keep
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: move, remove
    * [[:WG1BallotGanz|Ganz]]: remove, move, keep
    * [[:WG1BallotGleckler|Gleckler]]: move, remove
    * [[:WG1BallotHsu|Hsu]]: remove, move, keep
    * [[:WG1BallotLucier|Lucier]]: undecided
    * [[:WG1BallotMedernach|Medernach]]: move, remove, keep, undecided
    * [[:WG1BallotRead|Read]]: move
    * [[:WG1BallotShinn|Shinn]]: move
    * [[:WG1BallotSnellPym|SnellPym]]: move, remove, keep
...
EvalDefine for which Schemes already handle this.
  ...
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: yes
    * [[:WG1BallotGanz|Ganz]]: yes, but
    * [[:WG1BallotGleckler|Gleckler]]: yes
    * [[:WG1BallotHsu|Hsu]]: yes
    * [[:WG1BallotLucier|Lucier]]: yes, no
    * [[:WG1BallotMedernach|Medernach]]: yes, unspecified
    * [[:WG1BallotRead|Read]]: yes
    * [[:WG1BallotShinn|Shinn]]: yes
    * [[:WG1BallotSnellPym|SnellPym]]: yes
...
`#t` for `promise?` in addition to one other type.
  ...
  * '''Default:''' unspecified
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: type-check, unspecified
    * [[:WG1BallotGanz|Ganz]]: type-check, unspecified
    * [[:WG1BallotGleckler|Gleckler]]: unspecified
    * [[:WG1BallotHsu|Hsu]]: remove, undecided
    * [[:WG1BallotLucier|Lucier]]: type-check, unspecified
    * [[:WG1BallotMedernach|Medernach]]: remove, unspecified, type-check, undecided
    * [[:WG1BallotRead|Read]]: undecided
    * [[:WG1BallotShinn|Shinn]]: unspecified, type-check
    * [[:WG1BallotSnellPym|SnellPym]]: type-check, unspecified, remove
...
`yes` to add it as a not-necessarily disjoint predicate.
  ...
  * '''Default:''' no
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: disjoint, yes
    * [[:WG1BallotGanz|Ganz]]: yes, no, undecided
    * [[:WG1BallotGleckler|Gleckler]]: disjoint, yes
    * [[:WG1BallotHsu|Hsu]]: yes, disjoint, undecided
    * [[:WG1BallotLucier|Lucier]]: disjoint
    * [[:WG1BallotMedernach|Medernach]]: yes, undecided, disjoint, no
    * [[:WG1BallotRead|Read]]: disjoint
    * [[:WG1BallotShinn|Shinn]]: yes
    * [[:WG1BallotSnellPym|SnellPym]]: yes, (no disjoint)
  * '''Results:''' '''yes''', disjoint, undecided, no
  * '''Ratios:''' 5:4, 7:0, 7:0
  * '''Rationales:'''

 `Cowan`::
  Promises should be disjoint, specifically disjoint from procedures. See DisjointProcedures for which are and which are not.
 `Ganz`::
...
lines, and `none` to leave as-is.
  ...
  * '''Default:''' none
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: no, no-return
    * [[:WG1BallotGanz|Ganz]]: no-return
    * [[:WG1BallotGleckler|Gleckler]]: no, no-return
    * [[:WG1BallotHsu|Hsu]]: no
    * [[:WG1BallotLucier|Lucier]]: no, undecided
    * [[:WG1BallotMedernach|Medernach]]: no
    * [[:WG1BallotRead|Read]]: no
    * [[:WG1BallotShinn|Shinn]]: no-return, no
    * [[:WG1BallotSnellPym|SnellPym]]: no
...
Vote `remove` to remove `digit-value` entirely, `remove-radix` to remove `digit-value` entirely, but add the radix argument to `char-numeric?` as described above, or `keep` to keep as is.
  ...
  * '''Voters:''' 
    ...
    * [[:WG1BallotGanz|Ganz]]: unicode-radix, ascii-radix, remove-radix, keep
    * [[:WG1BallotGleckler|Gleckler]]: remove, ascii-hex
    * [[:WG1BallotHsu|Hsu]]: remove, keep, undecided
    * [[:WG1BallotLucier|Lucier]]: ascii-hex, keep
    * [[:WG1BallotMedernach|Medernach]]: remove, undecided, ascii-hex, keep, unicode-hex
    * [[:WG1BallotShinn|Shinn]]: remove, keep, undecided
    * [[:WG1BallotSnellPym|SnellPym]]: unicode-hex, ascii-hex, keep, remove
...
wins.
  ...
  * '''Voters:''' 
    ...
    * [[:WG1BallotGleckler|Gleckler]]: yes
    * [[:WG1BallotHsu|Hsu]]: undecided
    * [[:WG1BallotLucier|Lucier]]: yes, no, undecided
    * [[:WG1BallotMedernach|Medernach]]: yes
    * [[:WG1BallotRead|Read]]: yes
    * [[:WG1BallotShinn|Shinn]]: yes
    * [[:WG1BallotSnellPym|SnellPym]]: yes, no
...
officially which is preferred.
  ...
  * '''Default:''' unspecified
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: singular
    * [[:WG1BallotGanz|Ganz]]: singular, plural
    * [[:WG1BallotGleckler|Gleckler]]: singular, plural, unspecified
    * [[:WG1BallotHsu|Hsu]]: plural
    * [[:WG1BallotLucier|Lucier]]: plural, unspecified, undecided
    * [[:WG1BallotMedernach|Medernach]]: plural
    * [[:WG1BallotRead|Read]]: singular, unspecified
    * [[:WG1BallotShinn|Shinn]]: plural, singular
    * [[:WG1BallotSnellPym|SnellPym]]: singular
...
If the value of `current-jiffy` is to be both space-efficient (that is, a fixnum) and reasonably precise (say, microsecond timing), it needs to wrap around: 30-bit fixnums on a 32-bit system will wrap every 17 minutes.  That means an application needs to know what the maximum value is before it wraps back to zero.  The `jiffy-modulus` function returns the maximum value of the current jiffy plus 1.  Alternatively, jiffies can be signed and wrap from (- (jiffy-modulus) 1) to (- (jiffy-modulus)), which is easier for the implementation but harder for the user.
  ...
  * '''Default:''' no
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: unsigned
    * [[:WG1BallotGanz|Ganz]]: undecided
    * [[:WG1BallotGleckler|Gleckler]]: undecided
    * [[:WG1BallotHsu|Hsu]]: undecided, unsigned, no
    * [[:WG1BallotMedernach|Medernach]]: undecided
    * [[:WG1BallotShinn|Shinn]]: no
    * [[:WG1BallotSnellPym|SnellPym]]: unsigned, signed, no
...
These same settings apply to the `include-ci` syntax.
  ...
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: r6rs
    * [[:WG1BallotGanz|Ganz]]: r6rs, r6rs+directives, never-fold, always-fold
    * [[:WG1BallotGleckler|Gleckler]]: r6rs, r6rs+directives
    * [[:WG1BallotHsu|Hsu]]: r6rs, always-fold, r6rs+directives, undecided, never-fold
    * [[:WG1BallotLucier|Lucier]]: r6rs, undecided
    * [[:WG1BallotMedernach|Medernach]]: r6rs, r6rs+directives
    * [[:WG1BallotRead|Read]]: r6rs
    * [[:WG1BallotShinn|Shinn]]: r6rs, r6rs+directives, always-fold
    * [[:WG1BallotSnellPym|SnellPym]]: always-fold, r6rs+directives, r6rs, never-fold 
...
Note that this is orthogonal to the question of #460, how `eqv?` works on procedures.  There should be little or no backward-compatibility hit for this change.
  ...
  * '''Default:''' same
  * '''Voters:''' 
    * [[:WG1BallotCowan|Cowan]]: different
    * [[:WG1BallotGanz|Ganz]]: same, undecided
    * [[:WG1BallotGleckler|Gleckler]]: different
    * [[:WG1BallotHsu|Hsu]]: undecided, different, same
    * [[:WG1BallotLucier|Lucier]]: different
    * [[:WG1BallotMedernach|Medernach]]: different
    * [[:WG1BallotRadul|Radul]]: undecided
    * [[:WG1BallotRead|Read]]: different
    * [[:WG1BallotShinn|Shinn]]: undecided, different
    * [[:WG1BallotSnellPym|SnellPym]]: different, same
