This proposal supersedes the [[http://srfi.schemers.org/srfi-1/srfi-1.html#AssociationLists|association-list section of SRFI 1]], maintaining compatibility but bringing it to parity with Common Lisp.
